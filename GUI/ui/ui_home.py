...
################################################################################
## Form generated from reading UI file 'homeUvHGrE.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Main_QF.setStyleSheet(u"")
        self.Main_QF.setFrameShape(QFrame.Shape.NoFrame)
        self.Main_QF.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        icon = QIcon()
        icon.addFile(u":/icons_v2/images/icons_v2/menu.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        self.btn_proc.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_proc.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/icons_v2/images/icons_v2/ai.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.btn_reg.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_reg.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/icons_v2/images/icons_v2/register.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.btn_mag.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_mag.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/icons_v2/images/icons_v2/database.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"")
        icon4 = QIcon()
        icon4.addFile(u":/icons_v2/images/icons_v2/close.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"")
        icon5 = QIcon()
        icon5.addFile(u":/icons_v2/images/icons_v2/gear.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.min_sf.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
"")
        icon6 = QIcon()
        icon6.addFile(u":/icons_v2/images/icons_v2/minimize-sign.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.max_sf.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
"")
        icon7 = QIcon()
        icon7.addFile(u":/icons_v2/images/icons_v2/maximize.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"")
        ...
        self.mg_main.setFrameShape(QFrame.Shape.StyledPanel)
        self.mg_main.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.mg_left.setFrameShape(QFrame.Shape.StyledPanel)
        self.mg_left.setFrameShadow(QFrame.Shadow.Raised)
...
"border-radius:12px;\n"
"")
        self.mg_left_1.setFrameShape(QFrame.Shape.StyledPanel)
        self.mg_left_1.setFrameShadow(QFrame.Shadow.Raised)
...
"border-radius:12px;\n"
"")
        self.mg_left_2.setFrameShape(QFrame.Shape.StyledPanel)
        self.mg_left_2.setFrameShadow(QFrame.Shadow.Raised)
...
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        self.mag_grly_img_show.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.reg_main.setFrameShape(QFrame.Shape.StyledPanel)
        self.reg_main.setFrameShadow(QFrame.Shadow.Raised)
...
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        self.reg_show_main_img.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        self.reg_show_crop_img.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons_v2/images/icons_v2/id-card.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon9 = QIcon()
        icon9.addFile(u":/icons_v2/images/icons_v2/image-gallery.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.reg_file_lineEdit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        self.reg_file_lineEdit.setStyleSheet(u"border-radius:8px;\n"
"background-color:rgba(255,255,255,90);")
        self.reg_file_lineEdit.setInputMethodHints(Qt.InputMethodHint.ImhNone)
        self.reg_file_lineEdit.setText(u"  \u8bf7\u6253\u5f00\u6ce8\u518c\u56fe\u50cf")
        self.reg_file_lineEdit.setFrame(True)
        self.reg_file_lineEdit.setEchoMode(QLineEdit.EchoMode.Normal)
        self.reg_file_lineEdit.setCursorPosition(9)
        self.reg_file_lineEdit.setAlignment(Qt.AlignmentFlag.AlignJustify|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.proc_main.setFrameShape(QFrame.Shape.StyledPanel)
        self.proc_main.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.proc_mian_top_left.setFrameShape(QFrame.Shape.StyledPanel)
        self.proc_mian_top_left.setFrameShadow(QFrame.Shadow.Raised)
...
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        self.det_pano_img.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.proc_bar_qf.setFrameShape(QFrame.Shape.StyledPanel)
        self.proc_bar_qf.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        icon10 = QIcon()
        icon10.addFile(u":/icons_v2/images/icons_v2/begin.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon10.addFile(u":/icons_v2/images/icons_v2/pause.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
...
"}")
        icon11 = QIcon()
        icon11.addFile(u":/icons_v2/images/icons_v2/stop.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.proc_main_top_right.setFrameShape(QFrame.Shape.StyledPanel)
        self.proc_main_top_right.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.proc_main_bottom_left.setFrameShape(QFrame.Shape.StyledPanel)
        self.proc_main_bottom_left.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        icon12 = QIcon()
        icon12.addFile(u":/icons_v2/images/icons_v2/film-reel.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.process_file_edit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        self.process_file_edit.setStyleSheet(u" border-radius:8px;\n"
"background-color:rgba(255,255,255,90);")
        self.process_file_edit.setInputMethodHints(Qt.InputMethodHint.ImhNone)
        self.process_file_edit.setEchoMode(QLineEdit.EchoMode.Normal)
...
"}")
        icon13 = QIcon()
        icon13.addFile(u":/icons_v2/images/icons_v2/folder.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"        }")
        ...
        self.process_dir_edit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        self.process_dir_edit.setStyleSheet(u" border-radius:8px;\n"
"background-color:rgba(255,255,255,90);")
        self.process_dir_edit.setInputMethodHints(Qt.InputMethodHint.ImhNone)
        self.process_dir_edit.setEchoMode(QLineEdit.EchoMode.Normal)
        ...
        self.proc_main_bottom_right.setFrameShape(QFrame.Shape.StyledPanel)
        self.proc_main_bottom_right.setFrameShadow(QFrame.Shadow.Raised)
...
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        self.match_show_img.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"border-radius:12px;\n"
"}")
        self.Device_Set.setFrameShape(QFrame.Shape.StyledPanel)
        self.Device_Set.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        icon14 = QIcon()
        icon14.addFile(u":/icons_v2/images/icons_v2/apple.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"border-radius:12px;\n"
"}")
        self.Sample_Set.setFrameShape(QFrame.Shape.StyledPanel)
        self.Sample_Set.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        icon15 = QIcon()
        icon15.addFile(u":/icons_v2/images/icons_v2/score.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        self.sample_ft_slider.setOrientation(Qt.Orientation.Horizontal)
...
"}\n"
"")
        self.Model_Set.setFrameShape(QFrame.Shape.StyledPanel)
        self.Model_Set.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        icon16 = QIcon()
        icon16.addFile(u":/icons_v2/images/icons_v2/motion-sensor.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"border-radius:12px;")
        self.Thres_Set.setFrameShape(QFrame.Shape.StyledPanel)
        self.Thres_Set.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        icon17 = QIcon()
        icon17.addFile(u":/icons_v2/images/icons_v2/face-scanner.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
